...
- Se você fosse o diretor de uma escola, quais qualificações você olharia em um candidato a professor? 
...
.pull-right[
- Terça-feira das 20:20-21:00

- Quinta-feira das 20:20-21:00
]
...
A APCC consistirá de uma aula sobre estatística no contexto da licenciatura em química.

A nota será atribuída de acordo com:

- o plano de aula;

- desempenho do aluno na exposição da aula.

<br>

Maiores detalhes estarão disponíveis no moodle.
...
&#10004; Será **aprovado** o aluno com 75% de presença e obtiver  $MF\geq6$, em que
		$$MF=0,7MP+0,3NA,$$
em que $MP=\frac{N1+N2+N3}{3}$ é nota média das provas, $Ni=Pi+Qi \,(i=1,2,3)$ com $Pi$ é a $i$-ésima prova (8 pontos) e $Qi$ é o $i$ésimo quiz (2pontos) e $NA$ é nota da APCC. 
...
&#10004; O aluno com $MF<6$ deverá fazer a prova de recuperação (**matéria toda** e **sem consulta**) no dia 08-07-2025. A média final será recalculada por 
$$MFr=\frac{MF+R}{2},$$ 
...
&#128680; Conhecimento de cálculo integral e diferencial. 

<br>

&#128680; Disciplina de 4o período.
...
**Aprendi e consigo aplicar os conceitos** de Cálculo e fundamentos de matemática?
...
&#10004; Disciplina: 2025 - S1 - Probabilidade e Estatística
